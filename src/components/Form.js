...
function Form(props) {
  ...
  const [feedItemURL, setFeedItemURL] = useState('');
  ...
  const handleFeedItemSubmit = (e) => {
    ...
    notify('Congrats! Feed Item "'+feedItem.name+'" Added.');
  };
  ...
  const handleFeedItemAutoGeneration = () => {
    ...
    notify('Cheater! You\'ve just added "' + feedItemsAutoGenerated.length + '" items to the feed.');
  };
  ...
  return (
    <>
      ...
      <div className='Form-extras'>
        <p>This button will add random number of autogenerated items to the feed list. (min 6, max 25 items)</p>
